<template>
	...
	<view class="content">
		<uni-nav-bar @clickRight="dorightclick" :leftText="title" fixed status-bar background-color='#e54847' color="#fff"
		 right-icon="bars" title="狗眼电影"></uni-nav-bar>
...
<script>
	...
	export default {
		...
		data() {
			return {
				url: 'http://www.zdziyuan.com/inc/api_zuidall.php?',
				data: [],
				pg: 1,
				t: 0,
				class: [],
		...
		created() {
			...
			axios.get(this.url + 'ac=videolist&pg=1')
				.then(res => this.xmljs(res.data))
				.then(x => {
